...
if (!fs.existsSync(".env.production")) {
  ...
  console.error("   Please create .env.production with your production environment variables.");
  process.exit(1);
}
...
setTimeout(() => {
  try {
    ...
    console.error("❌ Failed to apply migrations. Check your database connection.");
    process.exit(1);
  }
}, 5000);
